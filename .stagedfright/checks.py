...
MAP_PATH_EXPECTED_HARDCODED_DATA_COUNT = {
    ...
    "primo/opt_model/model_options.py": 15,
    "primo/opt_model/model_with_clustering.py": 30,
    ...
    "primo/utils/config_utils.py": 50,
    ...
    "primo/utils/override_utils.py": 20,
    ...
    "primo/utils/tests/test_config_utils.py": 185,
